...
- correspondingFigure:填写每个part对应的聚类图，有时没有聚类的降维图，可填写带有clusterName的热图。需要注意格式。如：1-a(代表Figure 1.a),supplementary/extended files 里的相关图命名格式写 s1-a/extended1-a，没有对应的图填notAvailable
